...
public static class HonorFear{
	public const float pluss = 0.4f; // barFillAmount = amount * 0.01f / pluss
}
...
public static class Gold{
	public const float goldPerWorker = 0.2f;
}
...
public static class Ships{
	public const float shipsPerWorker = 0.05f;
	public const float woodCost = 0.15f;
	public const float goldCost = 0.08f;
	public const int troopsPerShip = 15;
}

public static class Troops{
	public const float troopsPerWorker = 0.15f;
	public const float foodCost = 0.04f;
	public const float goldCost = 0.12f;
